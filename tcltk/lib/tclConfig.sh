...
# installed.
TCL_PREFIX='/m/dev/pino/tcltk'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/m/dev/pino/tcltk'
...
# build directory.
TCL_BUILD_LIB_SPEC='-LC:/msys64/tmp/pino-tcltk-build/tcl9.0.3/win -ltcl90'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/m/dev/pino/tcltk/lib -ltcl90'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/m/dev/pino/tcltk/include'
...
# compiled.
TCL_SRC_DIR='C:/msys64/tmp/pino-tcltk-build/tcl9.0.3'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/m/dev/pino/tcltk\lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-LC:/msys64/tmp/pino-tcltk-build/tcl9.0.3/win -ltclstub'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/m/dev/pino/tcltk/lib -ltclstub'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='C:/msys64/tmp/pino-tcltk-build/tcl9.0.3/win/libtclstub.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/m/dev/pino/tcltk/lib/libtclstub.a'
