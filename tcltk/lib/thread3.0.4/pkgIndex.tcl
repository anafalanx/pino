...
if {[package vsatisfies [package provide Tcl] 9.0-]} {
    package ifneeded thread 3.0.4 \
	    [list load [file join $dir tcl9thread304.dll] [string totitle thread]]
} else {
    package ifneeded thread 3.0.4 \
	    [list load [file join $dir thread304.dll] [string totitle thread]]
}
...
package ifneeded ttrace 3.0.4 [list ::apply {{dir} {
	...
	source [file join $dir ttrace.tcl]
	    ...
	    || ![catch {zipfs mount [file join $dir tcl9thread304.dll] //zipfs:/lib/thread}]} {
	source //zipfs:/lib/thread/ttrace.tcl
    } elseif {[file exists //zipfs:/app/thread_library/ttrace.tcl]
	    || ![catch {zipfs mount [file join $dir tcl9thread304.dll] //zipfs:/app/thread_library}]} {
